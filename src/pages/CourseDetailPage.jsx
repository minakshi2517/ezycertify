        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{ position: 'absolute', top: '1rem', right: '1rem', fontSize: '1.5rem', cursor: 'pointer' }}
            >
              ✕
            </button>
            ...
            {enrolled ? (
              <div style={{ textAlign: 'center', padding: '2rem 0' }}>
                <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--navy)' }}>Enrollment Request Received!</h3>
                <p style={{ color: 'var(--gray-600)', marginTop: '0.5rem' }}>
                  Our Ezycertify counselor will contact you shortly with batch schedule and fee structure.
                </p>
              </div>
            ) : (
              <>
                ...
                <p style={{ fontSize: '0.9rem', color: 'var(--gray-600)', marginBottom: '1.5rem' }}>
                  Fill in your details below to reserve your seat or speak with a mentor.
                </p>
