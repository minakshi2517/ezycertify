...
export default function LoginPage() {
  ...
  const handleSocialAuth = (provider) => {
    signIn(`student.${provider.toLowerCase()}@ezycertify.com`, 'password', `Learner via ${provider}`)
    navigate('/')
  }
          ...
          <>
            ...
            <form onSubmit={handleSendOtp}>
              ...
              <div style={{
                ...
                <a
                  href="#forgot"
                  onClick={(e) => { e.preventDefault(); alert('Password reset instructions have been sent to your email/phone.'); }}
                  style={{ color: '#0074e4', fontWeight: 600, textDecoration: 'underline' }}
                >
                  Forgot Password?
                </a>
              </div>
